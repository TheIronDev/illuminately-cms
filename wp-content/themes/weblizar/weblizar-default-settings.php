...
function weblizar_default_settings()
{
	...
	return $wl_theme_options=array(
			...
			'site_intro_title'=>'Discover Science',
...
{	$wl_theme_options = get_option('weblizar_options');
	...
	$wl_theme_options['slide_title'] = "";
	$wl_theme_options['slide_desc'] = "";
	$wl_theme_options['slide_btn_text'] = "";
	$wl_theme_options['slide_btn_link'] = "#";
	$wl_theme_options['slide_image_1'] = $ImageUrl2;
	$wl_theme_options['slide_title_1'] = "";
	$wl_theme_options['slide_desc_1'] = "";
	$wl_theme_options['slide_btn_text_1'] = "";
	$wl_theme_options['slide_btn_link_1'] = "#";
	$wl_theme_options['slide_image_2'] = $ImageUrl3;
	$wl_theme_options['slide_title_2'] = "";
	$wl_theme_options['slide_desc_2'] = "";
	$wl_theme_options['slide_btn_text_2'] = "";
